        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <form class="card login-form" wire:submit.prevent="login">
                        <div class="card-body">
                            <div class="title">
                                <h3>Login Now</h3>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" type="email" id="reg-email" required wire:model.defer="email">
                                <x-input-error :messages="$errors->get('email')" class="mt-2" />
                            </div>
                            <div class="form-group input-group">
                                <label for="reg-fn">Password</label>
                                <input class="form-control" type="password" id="reg-pass" required wire:model.defer="password">
                                <x-input-error :messages="$errors->get('password')" class="mt-2" />
                            </div>
                            <div class="d-flex flex-wrap justify-content-between bottom-content">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input width-auto" id="exampleCheck1" wire:model="remember">
